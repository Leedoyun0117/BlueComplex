...
namespace BlueComplex.Core.Tests
{
    ...
    public class Stage2ContentTests
    {
        ...
        {
            ("과거 부정 컴플렉스", "stage2_past_denial", "과거의 슬픔을 부정하여, 느끼지 않는다.", 2),
            ...
            ("자책 컴플렉스", "stage2_self_blame", "가족과 관련된 침체되는 감정을 자책하며 더 깊게 느낍니다.", 1),
            ("과한 기대 컴플렉스", "stage2_over_expectation", "현재의 행복이 미래까지 이어질 것이라고 강하게 확신합니다.", 2),
            ("의식 분산 컴플렉스", "stage2_scattered_mind", "두 명 이상의 인물에 대한 감정을 느끼면, 의식이 분산되어 침체됩니다.", 2),
            ("자기 분노 컴플렉스", "stage2_self_anger", "감정이 침체 쪽으로 기울어 있다면 자신의 모습에 분노합니다.", 2),
            ("전이 컴플렉스", "stage2_transference", "타인에게 가족의 모습을 겹쳐 본다.", 2),
            ("불신 컴플렉스", "stage2_distrust", "가까운 사람의 애정을 두려움으로 받아들인다.", 3),
            ("과대 해석 컴플렉스", "stage2_over_interpretation", "가까운 사람의 사랑을 느끼면, 다른 감정은 모두 무시하고, 사랑만 받아들입니다.", 1),
            ("피해 망상 컴플렉스", "stage2_persecution", "가까운 사람에게 슬픔을 느끼면 행복한 감정은 잊고, 슬픔을 더 깊게 느낍니다.", 3),
            ("사고 과다 컴플렉스", "stage2_overthinking", "과거의 감정을 배로 느낍니다. 과거의 감정이 아니라면 슬픔을 느낍니다.", 2)
        };
